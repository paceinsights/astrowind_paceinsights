...
metadata:
  ...
  openGraph:
    type: article
    images:
      - url: ~/assets/images/article_images/when-the-pause-disappears.png
        width: 1200
        height: 675
  twitter:
...
I wrote more about where judgement still sits in [Where is my place in a world of AI?](/articles/where-is-my-place-in-a-world-of-ai). A practical overnight test of leaving work with agents is in [Personal Assistants Are Starting to Just Work](/articles/personal-assistants-are-starting-to-just-work).
