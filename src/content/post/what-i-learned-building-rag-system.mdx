...
image: ~/assets/images/A Year of Building Rapport AI/A year of building RAG - Step 4.png
author: "Samir Abid"
metadata:
...
import step1Image from '~/assets/images/A Year of Building Rapport AI/A year of building RAG - Step 1.png';
import step2Image from '~/assets/images/A Year of Building Rapport AI/A year of building RAG - Step 2.png';
import step3Image from '~/assets/images/A Year of Building Rapport AI/A year of building RAG - Step 3.png';
import step4Image from '~/assets/images/A Year of Building Rapport AI/A year of building RAG - Step 4.png';
...
<Image src={step1Image} alt="Step 1: Vector Database Architecture" class="my-8 rounded-lg shadow-lg" />
...
<Image src={step2Image} alt="Step 2: Hybrid Search Approach" class="my-8 rounded-lg shadow-lg" />
...
<Image src={step3Image} alt="Step 3: Re-ranker for Quality Improvement" class="my-8 rounded-lg shadow-lg" />
...
<Image src={step4Image} alt="Step 4: Graph Database Integration" class="my-8 rounded-lg shadow-lg" />
